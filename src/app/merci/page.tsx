            ...
            <div className="flex items-start gap-4 text-left mb-6">
              ...
              <div>
                <h3 className="font-medium text-slate-800 text-lg">
                  Notre chargé d&apos;entreprise vous contact dans les 24h
                </h3>
                <p className="text-slate-600">
                  Nous sommes impatients de discuter de vos besoins et de vous
                  présenter notre solution pour développer votre activité.
                </p>
              </div>
            </div>
