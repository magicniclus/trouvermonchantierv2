...
import { CalendarIcon, UserIcon, BuildingLibraryIcon, CurrencyEuroIcon } from "@heroicons/react/24/outline";
      ...
      <main className="min-h-[calc(100vh-80px)]">
        ...
        <div className="max-w-5xl mx-auto px-7 md:px-0 pt-10 pb-8">
          <h1 className="mx-auto max-w-4xl text-center text-4xl md:text-5xl font-bold tracking-tight text-slate-700 mt-7 mb-10">
            Échangez avec <span className="text-yellow-500">Khalid</span>, votre responsable partenaire France
          </h1>
          ...
          <div className="mt-8">
            <div 
              ...
              data-url="https://calendly.com/nicolascastera-rdv/rendez-vous-decouverte-1"
