  ...
  return (
    <section className="w-full relative flex items-center h-full py-5">
      <div className="mx-auto w-full h-full flex flex-col md:flex-row max-w-5xl items-center justify-between p-6 lg:px-4 md:py-6 py-16 z-10 h-[170px]">
        <div className="w-[40%] h-full rounded-2xl bg-slate-100 p-3 px-7 flex flex-col justify-center">
        ...
        <div className="w-[16%] h-full rounded-2xl bg-slate-100 p-3 px-7 flex flex-col justify-between text-white bg-bgPrimary">
          <ArrowTrendingUpIcon className="h-8 w-8" />
          <div className="flex flex-col">
            <h3 className="font-semibold">+ de 30 000</h3>
            <p className="text-xs">recherche par mois</p>
          </div>
        </div>
        <div className="w-[16%] h-full rounded-2xl bg-slate-100 p-3 px-7 flex flex-col justify-between text-white bg-bgPrimary">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-xs">artisans</p>
          </div>
        </div>{" "}
        <div className="w-[16%] h-full rounded-2xl bg-slate-100 p-3 px-7 flex flex-col justify-between text-white bg-bgPrimary">
