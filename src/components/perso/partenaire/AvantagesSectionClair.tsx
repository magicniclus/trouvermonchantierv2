            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
                    ...
                    <div className="space-y-8">
                        {/* Avantage 1 */}
                        <div className="flex items-start gap-4 group hover:-translate-y-0.5 hover:shadow-md/10 hover:ring-1 hover:ring-slate-200 transition-all duration-300 rounded-xl p-2 -m-2" data-animate>
                        ...
                        {/* Avantage 2 */}
                        <div className="flex items-start gap-4 group hover:-translate-y-0.5 hover:shadow-md/10 hover:ring-1 hover:ring-slate-200 transition-all duration-300 rounded-xl p-2 -m-2" data-animate data-animate-delay="100">
                        ...
                        {/* Avantage 3 */}
                        <div className="flex items-start gap-4 group hover:-translate-y-0.5 hover:shadow-md/10 hover:ring-1 hover:ring-slate-200 transition-all duration-300 rounded-xl p-2 -m-2" data-animate data-animate-delay="200">
                        ...
                        {/* Avantage 4 */}
                        <div className="flex items-start gap-4 group hover:-translate-y-0.5 hover:shadow-md/10 hover:ring-1 hover:ring-slate-200 transition-all duration-300 rounded-xl p-2 -m-2" data-animate data-animate-delay="300">
                            <div className="flex-shrink-0 w-12 h-12 rounded-full bg-amber-50 ring-1 ring-amber-100 flex items-center justify-center shadow-sm">
                    ...
                    <div className="lg:sticky lg:top-8" data-animate data-animate-delay="400">
                        <div className="relative group">
                            {/* Image principale */}
                            <div className="relative rounded-2xl overflow-hidden shadow-xl/10 ring-1 ring-slate-200/60 group-hover:scale-[1.01] group-hover:shadow-2xl/10 transition-all duration-500">
                                <img
                            ...
                            <div className="absolute -top-3 -right-3 bg-yellow-500 rounded-xl px-4 py-3 shadow-lg hover:-translate-y-0.5 transition-transform duration-300">
                            ...
                            <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white rounded-xl px-4 py-2 shadow-lg ring-1 ring-slate-200/70 hover:-translate-y-0.5 transition-transform duration-300">
